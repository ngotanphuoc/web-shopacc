<?php
          ...
          try {
               // $mail->SMTPDebug = 2;  // 0,1,2: chế độ debug. khi mọi cấu hình đều tớt thì chỉnh lại 0 nhé
                ...
                $nguoigui = 'phuocngopro1@gmail.com';
                $matkhau = ' equycokdxnmolusq';// mật khẩu của tài khoản ngolequanvh@gmail.com
    ...
    $email_array = explode(",",$recipients);*/
                ...
                $mail->Subject = 'Thư gửi từ SHOP ACC LMHT LMHTSHOP.vn.';      
                $noidungthu = $noidung.$code ;
