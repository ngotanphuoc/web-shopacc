<script>
    alert("SERVER IP: <?php echo isset($_SERVER['SERVER_ADDR']) ? $_SERVER['SERVER_ADDR'] : $_SERVER['SERVER_NAME']; ?>");
</script>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="border-bottom: 2px solid black; z-index: 1; background-color: black;">
    <div class="container-fluid">
        ...
        <span class="navbar-text d-none d-sm-inline" style="color: #00FF00; font-weight: bold; font-family: monospace; margin-left: 15px; border: 1px solid #00FF00; padding: 2px 8px; border-radius: 4px;">
            [Server: <?php echo isset($_SERVER['SERVER_ADDR']) ? $_SERVER['SERVER_ADDR'] : $_SERVER['SERVER_NAME']; ?>]
        </span>
