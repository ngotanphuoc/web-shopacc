<?php
include('models/quanLiLinhThu.php');
     class quanLiLinhThuController{
        var $model;
        function __construct()
        {
            $this->model = new quanLiLinhThu();
        }
        ...
        function store(){
            $target_dir = "../img/linhthu/";  // thư mục chứa file upload
            ...
            if ($status_upload) { // nếu upload file không có lỗi 
                $anh =  "img/linhthu/" . basename($_FILES["anh"]["name"]);
            }
