<?php
include('models/quanLiTrangPhuc.php');
     class quanLiTrangPhucController{
        var $model;
        function __construct()
        {
            $this->model = new quanLiTrangPhuc();
        }
        ...
        function store(){
            $target_dir = "../img/trangphuc/";  // thư mục chứa file upload
            ...
            if ($status_upload) { // nếu upload file không có lỗi 
                $anh =  "img/trangphuc/" . basename($_FILES["anh"]["name"]);
            }
